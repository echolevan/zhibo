            ...
            <div class="pull-right userright">
                <div class="record">
                    <div class="recording">
                        ...
                        <div class="clear"></div>
                        <form action="{{route('lecturer.article.update',$articles->id)}}" method="post">
                            {!! csrf_field()  !!}
                            {{ method_field('PUT') }}
                            <div class="tab-content">
                                <div class="message-1">
                                    <div class="viewtext">
                                        ...
                                        <div class="postview">
                                            <div class="re-txt">
                                                <span class="pull-left"><input name="title" value="{{$articles->title}}" type="text" class="viewtit form-control" placeholder="在此输入标题" id="viewtit" required/></span>
                                            </div>
                                            <div class="clear"></div>
                                            <div style="height:100%;padding-top: 10px;">
                                                ...
                                                <input type="hidden" name="img" value="{{$articles->img}}" />
                                                <p style="margin: 5px 0 0 0;"><img id="img_show" src="{{$articles->img}}" /></p>
                                            </div>
                                            <div class="clear"></div>
                                            <div class="viewcon">
                                                <textarea  id="content" name="contents" rows="10">{{$articles->contents}}</textarea>
                                            </div>
                                            <div class="clear"></div>
                                            <div>
