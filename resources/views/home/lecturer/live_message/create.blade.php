                ...
                <div class="record">
                    <div class="recording">
                        <div style="width:100%; height:50px;border-bottom:#ddd 1px solid;">
                            <div class="recordtit"><span style="width:5px; height:35px; display:block; float:left; background:#ff4436;"></span>发布直播信息</div>
                        </div>
                        <div class="clear"></div>
                        <form action="{{route('live.message.store')}}" method="post">
                            {!! csrf_field()  !!}
                                        ...
                                        <div class="postview">
                                            <div class="re-txt">
                                                <span class="pull-left">
                                                    <input name="title" value="{{old('title')}}" type="text" class="viewtit form-control" placeholder="在此输入标题" id="viewtit" required/>
                                                </span>
                                            </div>
                                            <div class="clear"></div>
                                            <div class="input-daterange input-group" style="margin-top: 10px;">

                                                <input name="start_time" size="16" type="text" value="{{old('start_time')}}" placeholder="预播开始时间" readonly class="form-control start_datetime" required/>
                                                <span class="input-group-addon">至</span>
                                                <input name="end_time" size="16" type="text" value="{{old('end_time')}}" placeholder="预播结束时间" readonly class="form-control end_datetime" required/>
                                            </div>
                                            <div class="clear"></div>
                                            <div style="height:100%;padding-top: 10px;">
                                                ...
                                                <input type="hidden" name="thumb" value="{{old('thumb')}}" required/>
                                                <p style="margin: 5px 0 0 0;"><img id="img_show" src="{{old('thumb')}}" /></p>
                                            </div>
                                            <div class="clear"></div>
                                            <div class="clear"></div>
                                            <div>
