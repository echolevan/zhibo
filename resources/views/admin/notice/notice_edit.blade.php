        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                <form class="am-form am-form-horizontal">
                                ...
                                <input type="hidden" value="{{$notice->id}}" id="notice_id" name="notice_id">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">公告标题/ Title(必填)</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" value="{{$notice->title}}" name="notice_title" id="notice_title">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea id="content" name="content" style="height: 400px;">{{$notice->content}}</textarea>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-email" class="am-u-sm-3 am-form-label">公告排序/Sort</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="notice_sort" value="{{$notice->sort}}" id="notice_sort">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9" id="article_status">
                                        <label class="am-radio-inline" style="line-height:8px;">
                                            <input type="radio" name="notice_status" value="yes" data-am-ucheck
                                                   @if($notice->status== 1)
                                                       checked
                                                   @endif
                                            >开启
                                        ...
                                        <label class="am-radio-inline" style="line-height:8px;">
                                            <input type="radio" name="notice_status" value="no" data-am-ucheck
                                                   @if($notice->status==0)
                                                   checked
                                                    @endif
                                            > 关闭
