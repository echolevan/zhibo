            ...
            <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                <form class="am-form am-form-horizontal">
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" value="" name="qqcs_name" id="qqcs_name">
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label for="user-name" class="am-u-sm-3 am-form-label">客服QQ/ QQ(必填)</label>
                        <div class="am-u-sm-9">
                            <input type="text" value="" name="qqcs_qq" id="qqcs_qq">
                        </div>
                    </div>
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9" id="article_status">
                            <label class="am-radio-inline" style="line-height:8px;">
                                <input type="radio" name="qqcs_status" value="yes" data-am-ucheck checked>开启
                            </label>
                            <label class="am-radio-inline" style="line-height:8px;">
                                <input type="radio" name="qqcs_status" value="no" data-am-ucheck> 关闭
                            </label>
                        </div>
                    </div>
                    <div class="am-form-group">
