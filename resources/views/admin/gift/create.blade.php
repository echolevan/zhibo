    ...
    <div class="admin-content-body">
        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                <form class="am-form am-form-horizontal" method="post" action="{{route('gift_store')}}">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input id="thumb_upload1" class="am-form-group am-form-file" type="file"
                                   style="display:none;">
                            <button class="am-btn am-btn-success am-btn-sm upload1" type="button"><i
                                        class="am-icon-cloud-upload"></i>&nbsp;&nbsp;<span
                                        class="bold">上传</span>
                            </button>
                            <img src="{{ old('gif') }}" alt="" id="img_show_1" >
                            <input id="web_log" name="gif" value="{{ old('gif') }}" type="hidden"/>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input id="thumb_upload2" class="am-form-group am-form-file" type="file"
                                   style="display:none;">
                            <button class="am-btn am-btn-success am-btn-sm upload2" type="button"><i
                                        class="am-icon-cloud-upload"></i>&nbsp;&nbsp;<span
                                        class="bold">上传</span>
                            </button>
                            <img src="{{ old('img') }}" alt="" id="img_show_2" >
                            <input id="web_log" name="img" value="{{ old('img') }}" type="hidden"/>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9 am-u-md-4 am-u-end col-end">
                            <div class="am-form-group am-form-icon ">
                                ...
                                <input size="16" type="text" readonly class="form-datetime-lang  am-form-field" name="promotion_begin_time" value="{{ old('promotion_begin_time') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9 am-u-md-4 am-u-end col-end">
                            <div class="am-form-group am-form-icon">
                                <i class="am-icon-calendar"></i>
                                <input size="16" type="text" readonly class="form-datetime-lang  am-form-field" name="promotion_end_time" value="{{ old('promotion_end_time') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9 am-u-md-4 am-u-end col-end">
                            <input type="text" name="promotion_price" value="{{ old('promotion_price') }}">
                        </div>
                    </div>
