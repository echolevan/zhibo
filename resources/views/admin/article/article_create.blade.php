                ...
                <form class="am-form am-form-horizontal">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-dropdown" data-am-dropdown>
                                            <select data-am-selected id="article_type">
                                                  <option value="3">系统文章</option>
                                            </select>
                                            {{--<small style="color:red;">请不要在后台发布讲师文章和讲师观点。</small>--}}
                                        </div>
                                </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea id="content" name="contents" style="height: 400px;"></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9" id="article_status">
                                        <label class="am-radio-inline" style="line-height:8px;">
                                            <input type="radio" name="article_status" value="yes" data-am-ucheck checked>开启
                                        </label>
                                        <label class="am-radio-inline" style="line-height:8px;">
                                            <input type="radio" name="article_status" value="no" data-am-ucheck> 关闭
                                        </label>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                            <label class="am-checkbox-inline" style="line-height:8px;">
                                                <input type="checkbox" id="article_recommend" value="" data-am-ucheck> 推荐
                                            </label>
                                            <label class="am-checkbox-inline" style="line-height:8px;">
                                                <input type="checkbox" id="article_hot"  value="" data-am-ucheck> 热门
                                            </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="am-form-group">
                        <div class="am-u-sm-9 am-u-sm-push-3">
                            <button type="button" id="sub" class="am-btn am-btn-primary">新增</button>
                        </div>
                    </div>
                </form>
            </div>
