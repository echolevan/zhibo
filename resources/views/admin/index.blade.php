...
<div class="admin-content-body">
    ...
    <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
        <li><a href="#" class="am-text-success"><span class="am-icon-btn am-icon-users"></span><br/>会员总数<br/>{{$user_count}}</a></li>
        <li><a href="#" class="am-text-secondary"><span class="am-icon-btn am-icon-user-md"></span><br/>本周新增会员<br/>{{$user_week}}</a></li>
        <li><a href="#" class="am-text-warning"><span class="am-icon-btn am-icon-user"></span><br/>讲师总数<br/>{{$lecturer_count}}</a></li>
        <li><a href="#" class="am-text-danger"><span class="am-icon-btn am-icon-user-md"></span><br/>本周新增讲师<br/>{{$lecturer_week}}</a></li>
    </ul>
